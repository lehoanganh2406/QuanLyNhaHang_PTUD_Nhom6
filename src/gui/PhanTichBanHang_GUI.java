...
public class PhanTichBanHang_GUI extends JFrame {
    ...
    private JPanel createHeaderPanel() {
        ...
        btnFilter.setFont(new Font("SansSerif", Font.BOLD, 15));
    ...
    private JPanel createMiddleSection() {
        ...
        chartArea.setPreferredSize(new Dimension(750, 320));
        
        JLabel lblChartTitle = new JLabel("BIỂU ĐỒ DOANH THU - CHI PHÍ - LỢI NHUẬN");
        lblChartTitle.setFont(new Font("SansSerif", Font.BOLD, 14));
        ...
        lblSummaryTitle.setFont(new Font("SansSerif", Font.BOLD, 14));
        ...
        JPanel bottomBox = new JPanel(new BorderLayout(0, 15));
        ...
        lblQuick.setFont(new Font("SansSerif", Font.BOLD, 13));
        ...
        txtBox.setFont(new Font("SansSerif", Font.PLAIN, 15));
